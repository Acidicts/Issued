...
# S3-compatible object storage for Active Storage, used to reach Cloudflare R2.
gem "aws-sdk-s3", "~> 1.48"

group :development, :test do  # Load environment variables from .env for local development
